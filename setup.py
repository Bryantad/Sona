...
setup(
    ...
    description="The world's first AI-native programming language with cognitive accessibility features",
    ...
    keywords="programming-language artificial-intelligence cognitive-accessibility ai-native",
    project_urls={
