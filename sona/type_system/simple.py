...
class FunctionType(Type):
    ...
    def __init__(self, param_types, return_type, location: Optional[SourceLocation] = None):
...
class SimpleTypeChecker:
    """Simplified type checker for basic Sona expressions"""

    def __init__(self):
        self.env = {}

    def check_type(self, expr) -> str:
        """Check the type of an expression and return as string"""
        try:
...
__all__ = [
    ...
    'PrimitiveType', 'TypeVariable', 'FunctionType',
    'TypeInferenceError', 'SimpleTypeChecker',
