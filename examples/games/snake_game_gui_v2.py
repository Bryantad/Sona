...
class SnakeGameGUI:
    def __init__(self, master):
        ...
        self.instructions = tk.Label(
            master,
            text="Use arrow keys or WASD to move, Space to restart",
            font=("Arial", 10),
            bg="#333333",
            fg="#CCCCCC"
        )
        ...
        self.game_over_flag = False
          # Bind arrow keys and WASD keys for true gamers
        # Arrow keys
    ...
    def start_countdown(self, count):
        if count > 0:
            ...
            self.master.after(500, lambda: self.start_game())
