...
### Persistent Memory Governance Release

**Changed**

- Aligned extension packaging to Sona `0.13.0`.
- Updated Marketplace metadata and bundled runtime version surfaces.
- Carries the governance layer (policy, audit, compliance) from the core release line.

---

## [0.12.0] - 2026-03-15

### Language-First Boundary Release

**Changed**

- Aligned extension packaging to Sona `0.12.0`.
- Updated Marketplace metadata and bundled runtime version surfaces.
- Carries the runtime boundary split and low-risk native `.smod` additions from the core release line.

---

## [0.11.1] - 2026-03-14

### Minor Stabilization Update

**Fixed**

- Corrected `when` subject matching behavior in the runtime.
- Removed dead continue-path logic and unused control-flow hooks.
- Improved interpreter startup by reusing a single parser instance.

**Added**

- Added validated `for a, b in value` destructuring support.

**Packaging**

- Aligned extension metadata to the 0.11.1 release line.
- Prepared the extension for Marketplace-first distribution.
