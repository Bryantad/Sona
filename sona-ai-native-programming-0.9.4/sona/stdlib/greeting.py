...
class GreetingModule: def __init__(self): """Initialize the greeting module"""
        pass

    def say(self, message): """Say a message"""
        return message

    def hi(self): """Say hi"""
        return "Hello there!"

    def hello(self, name = ""): """Say hello to someone"""
        if name: return f"Hello, {name}!"
        return "Hello, World!"

    def greet(self, name = "friend"): """Greet someone"""
